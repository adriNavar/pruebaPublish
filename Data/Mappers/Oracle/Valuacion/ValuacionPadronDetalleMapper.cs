...
{
    public class ValuacionPadronDetalleMapper : EntityTypeConfiguration<ValuacionPadronDetalle>
    {
        public ValuacionPadronDetalleMapper()
        {

            this.ToTable("VAL_PADRON_INM");
            ...
            this.Property(a => a.Fecha_Vigencia_Desde)
                 .IsConcurrencyToken()
             .HasColumnName("FECHA_VIGENCIA_DESDE");
            this.Property(a => a.Fecha_Vigencia_Hasta)
                 .IsConcurrencyToken()

...
{
    public class ValorBasicoTierraStoreMapper : EntityTypeConfiguration<ValorBasicoTierraStore>
    {
        public ValorBasicoTierraStoreMapper()
        {

            this.ToTable("VAL_VBT_SP");
           
            this.Property(a => a.IdValorBasicoTierraStore)
                .IsRequired()
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity)
                .HasColumnName("ID_VAL_VBT_SP");
            ...
            this.HasKey(a => a.IdValorBasicoTierraStore);
        }
    }
}

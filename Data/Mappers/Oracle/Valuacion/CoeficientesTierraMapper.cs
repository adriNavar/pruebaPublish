...
{
    public class CoeficientesTierraMapper : EntityTypeConfiguration<CoeficientesTierra>
    {
        public CoeficientesTierraMapper()
        {
            	

            this.ToTable("VAL_COEFICIENTE_TIERRA");

            this.Property(a => a.Id_Coeficiente_Tierra)
                .IsRequired()
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity)
                .HasColumnName("ID_VAL_COEFICIENTE_TIERRA");
            ...
            this.HasKey(a => a.Id_Coeficiente_Tierra);
        }
    }
}

...
{
    public class INMTipoCaracteristicaMapper : EntityTypeConfiguration<INMTipoCaracteristica>
    {
        public INMTipoCaracteristicaMapper()
        {
            this.ToTable("INM_TIPO_CARACTERISTICA");

            this.HasKey(a => a.IdTipoCaracteristica);

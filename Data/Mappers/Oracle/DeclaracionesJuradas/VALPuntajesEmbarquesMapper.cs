...
{
    public class VALPuntajesEmbarquesMapper : EntityTypeConfiguration<VALPuntajesEmbarques>
    {
        public VALPuntajesEmbarquesMapper()
        {
            this.ToTable("VAL_PUNTAJES_EMBARQUES");

            this.HasKey(a => a.IdPuntajeEmbarque);

            this.Property(a => a.IdPuntajeEmbarque)
                .IsRequired()
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity)
                .HasColumnName("ID_PUNTAJE_EMBARQUE");            

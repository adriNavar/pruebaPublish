...
{
    public class VALCoeficientesIncisosMapper : EntityTypeConfiguration<VALCoeficientesIncisos>
    {
        public VALCoeficientesIncisosMapper()
        {
            this.ToTable("VAL_COEFICIENTES_INCISOS");

            this.HasKey(a => a.IdCoeficienteInciso);

            this.Property(a => a.IdCoeficienteInciso)
                .IsRequired()
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity)
                .HasColumnName("ID_COEF_INCISO");

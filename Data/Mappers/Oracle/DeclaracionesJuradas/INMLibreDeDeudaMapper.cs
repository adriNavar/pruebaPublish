...
{
    public class INMLibreDeDeudaMapper : EntityTypeConfiguration<INMLibreDeDeuda>
    {
        public INMLibreDeDeudaMapper()
        {
            this.ToTable("INM_LIBRE_DEUDA");

            this.HasKey(a => a.IdLibreDeuda);

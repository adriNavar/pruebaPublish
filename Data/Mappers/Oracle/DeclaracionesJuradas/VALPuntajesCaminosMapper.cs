...
{
    public class VALPuntajesCaminosMapper : EntityTypeConfiguration<VALPuntajesCaminos>
    {
        public VALPuntajesCaminosMapper()
        {
            this.ToTable("VAL_PUNTAJES_CAMINOS");

            this.HasKey(a => a.IdPuntajeCamino);

            this.Property(a => a.IdPuntajeCamino)
                .IsRequired()
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity)
                .HasColumnName("ID_PUNTAJE_CAMINO");
